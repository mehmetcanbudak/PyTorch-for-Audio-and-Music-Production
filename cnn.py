...
class CNNNetwork(nn.Module):
    def __init__(self):  # constructor
        super(CNNNetwork, self).__init__()  # call parent constructor
...
if __name__ == "__main__":
    ...
    # batch_size = 16
    # summary(cnn, input_size=(batch_size, 1, 64, 44))
    summary(cnn, (1, 64, 44))  # print model summary
    # summary(cnn, (1, 64, 44), device=device)  # print model summary
